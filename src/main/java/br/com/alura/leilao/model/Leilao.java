...
public class Leilao {
    ...
    public Leilao(@NotNull @NotBlank String nome,
                  @NotNull @DecimalMin("0.1") BigDecimal valorInicial, @NotNull Usuario usuario) {
        this.nome = nome;
        this.valorInicial = valorInicial;
    ...
    public Leilao(@NotNull @NotBlank String nome,
                  @NotNull @DecimalMin("0.1") BigDecimal valorInicial, @NotNull LocalDate data,
    ...
    public Date getDataAberturaDate() {
        return java.util.Date.from(
            this.dataAbertura.atStartOfDay().atZone(ZoneId.systemDefault()).toInstant()
        );
    }
